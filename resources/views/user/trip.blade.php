				...
				<div class="row">
					<div class="col-md-10 col-md-push-1">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group {{ $errors->has('country') ? ' has-error' : '' }}">
									<div class="">
										<label>From Country </label> {{ Form::select('country', $countries, $trip->country or old('country'), ['placeholder' => 'Please select...', 'class' => 'form-control', 'id' => 'country']) }}
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group {{ $errors->has('country_to') ? ' has-error' : '' }}">
									<div class="">
										<label>To Country </label> {{ Form::select('country_to', $countries, $trip->country_to or old('country_to'), ['placeholder' => 'Please select...', 'class' => 'form-control', 'id' => 'dcountry']) }}
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<div class="">
										<label>Budget in USD (Optional)</label> <input name="budget" class="form-control" type="text" placeholder="Your budget (optional)" value="{{ old('budget') }}"/>
					...
					<div class="addLocations col-md-10 col-md-push-1">
						...
						<div class="row child1">
							<div class="col-md-3">
								<div class="form-group">
									<label>City</label> <input type="text" class="form-control" name="city_transit[]" value="{{ $transit[0]['city'] or '' }}"/>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
